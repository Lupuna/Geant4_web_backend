...
def update_document(sender, instance, **kwargs):
    ...
    logger.info(f"SIGNAL: Обновление индекса для UserExampleCommand id={instance.pk} началось")
    UserExampleCommandDocument().update(instance)
    logger.info(f"SIGNAL: Обновление индекса для UserExampleCommand id={instance.pk} закончилось")